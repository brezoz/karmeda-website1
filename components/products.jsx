...
const PRODUCTS = [
  ...
  { cat: 'corporate', name: 'Polo Shirt Premium', en: 'Premium Polo Shirt', desc: 'Cotton pique 200gsm, fit tailored', en_desc: 'Cotton pique 200gsm, tailored fit', price: '95–160rb', moq: 'MOQ 100', images: ['assets/polo-formula.webp','assets/polo-tehgelas.webp','assets/polo-anekaseafood.webp'], interval: 3000 },
  ...
  { cat: 'fnb', name: 'Baju Pelayan', en: 'Server / Waiter Uniform', desc: 'Seragam pelayan restoran & hospitality, rapi & tahan cuci', en_desc: 'Restaurant & hospitality server uniform, neat & wash-resistant', price: '140–220rb', moq: 'MOQ 30', images: ['assets/pelayan-resto1.webp','assets/pelayan-resto2.webp'], interval: 3000 },
  ...
  { cat: 'outsourcing', name: 'Seragam Security', en: 'Security Uniform', desc: 'PDL security lengkap dengan emblem & atribut standar', en_desc: 'Full security PDL with emblem & standard attributes', price: '180–280rb', moq: 'MOQ 30' },
  { cat: 'outsourcing', name: 'Cleaning Services', en: 'Cleaning Services', desc: 'Seragam OB/cleaning tahan cuci, breathable untuk kerja harian', en_desc: 'OB/cleaning uniform, wash-resistant & breathable for daily use', price: '140–220rb', moq: 'MOQ 30', tone: 'green' },
  { cat: 'outsourcing', name: 'Seragam Pabrik', en: 'Factory Uniform', desc: 'Atasan kerja pabrik dengan bordir divisi & QR/ID tag', en_desc: 'Factory work shirt with division embroidery & QR/ID tag', price: '160–260rb', moq: 'MOQ 50', tone: 'dark' },
];
