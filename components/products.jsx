...
const PRODUCTS = [
  ...
  { cat: 'corporate', name: 'Polo Shirt Premium', en: 'Premium Polo Shirt', desc: 'Cotton pique 200gsm, fit tailored', en_desc: 'Cotton pique 200gsm, tailored fit', price: '95–160rb', moq: 'MOQ 100', images: ['assets/polo-formula.webp','assets/polo-tehgelas.webp','assets/polo-adaro.webp','assets/polo-ofi.webp','assets/polo-ofi-navy.webp','assets/Polo2_w-scaled.webp'], interval: 3000 },
  ...
  { cat: 'school', name: 'Seragam Sekolah International', en: 'International School Uniform', desc: 'Bahan oxford, jahit kuat', en_desc: 'Oxford fabric, durable stitching', price: '120–180rb', moq: 'MOQ 100', images: ['assets/baju sekolaha pria.png','assets/baju sekolahwanita.png','assets/sekolah2.png'], interval: 3000 },
  { cat: 'school', name: 'Baju PE (Olahraga)', en: 'PE (Sport) Uniform', desc: 'Sesuai standar Kwarnas', en_desc: 'Per Kwarnas standards', price: '95–140rb', moq: 'MOQ 50', images: ['assets/seragam-shb.webp'], interval: 3000 },
  { cat: 'jacket', name: 'Jas', en: 'Jacket', desc: 'Drill twill, bordir custom', en_desc: 'Twill drill, custom embroidery', price: '220–380rb', moq: 'MOQ 50', tone: 'green', images: ['assets/jas-shb.webp'], interval: 3000 },
  { cat: 'jacket', name: 'Jaket Bomber', en: 'Bomber Jacket', desc: 'Bahan taslan anti-angin, bordir logo custom, cocok untuk seragam komunitas & korporat', en_desc: 'Taslan wind-resistant fabric, custom logo embroidery, ideal for community & corporate uniform', price: '280–450rb', moq: 'MOQ 30', tone: 'dark', images: ['assets/jas-shb.webp'], interval: 3000 },
  { cat: 'jacket', name: 'Jaket Parka', en: 'Parka Jacket', desc: 'Parasut waterproof dengan hood, furing fleece, cocok untuk outdoor & lapangan', en_desc: 'Waterproof shell with hood, fleece lining, ideal for outdoor & field use', price: '350–550rb', moq: 'MOQ 30', images: ['assets/jas-shb.webp'], interval: 3000 },
  { cat: 'jacket', name: 'Jaket Winter', en: 'Winter Jacket', desc: 'Padding fiber hollow, tahan dingin, cocok untuk gudang pendingin & proyek outdoor', en_desc: 'Hollow fiber padding, cold-resistant, ideal for cold storage & outdoor projects', price: '420–650rb', moq: 'MOQ 20', tone: 'green', images: ['assets/jas-shb.webp'], interval: 3000 },
  ...
  { cat: 'fnb', name: 'Baju Chef', en: 'Chef Jacket', desc: 'Double-breasted, heat-resistant, katun berat premium', en_desc: 'Double-breasted, heat-resistant, premium heavy cotton', price: '220–340rb', moq: 'MOQ 20', tone: 'green', images: ['assets/baju-chef4.webp','assets/baju-chef3.webp','assets/baju-chef2.webp'], interval: 3000 },
